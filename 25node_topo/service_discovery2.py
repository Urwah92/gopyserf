...
def filter_by_resources(
    ...
    mask = (
        ...
        ((min_ram<=0)     | (x["ram"]     >= min_ram)) &   # float RAM compared to int threshold
...
def main():
    ...
    ap.add_argument("--min-ram", type=int, default=0)       # threshold still int (can switch to float if you want)
